...
for image_path in imagePaths:
    ...
    # TODO: Add bounding boxes and labels of the detected objects to `img` using
    #  `viz_utils.visualize_boxes_and_labels_on_image_array(..)`. Tipps: All required data is either already
    #  available or contained in the dict-like structure returned when applying the model to `img`. TensorFlow models
    #  return tensors with an additional batch dimension that is not required for visualitation, i.e. take only
    #  index[0] and convert it to a numpy array. TensorFlow returns detected classes as floats, but the visualization
    #  requires ints.
    #
    # ???
    #
